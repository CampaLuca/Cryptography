...
_sage_const_1 = Integer(1); _sage_const_0p18 = RealNumber('0.18'); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_131 = Integer(131); _sage_const_1400 = Integer(1400); _sage_const_20 = Integer(20); _sage_const_1286 = Integer(1286); _sage_const_73 = Integer(73); _sage_const_30 = Integer(30)
...
def jochemz_may_multivariate(N, eq, bounds):
    ...
    for j in range(h+_sage_const_2 ):
        ref_monomial = I**j
    ...
    for j in range(h+_sage_const_1 ):
        sets[j] = sets[j]-sets[j+_sage_const_1 ]
    ...
    for i in range(len((eq**h).monomials())):
        eq_reduced += (M[M.nrows()-_sage_const_4 ][i]//(X**((eq**h).monomials()[i].degree(x))*Y**((eq**h).monomials()[i].degree(y))))*(eq**h).monomials()[i]
